...
import ir.saltech.gradle.tasks.CopyFileTask
import ir.saltech.gradle.tasks.MakeReleaseNotesTask
import ir.saltech.gradle.tasks.VersionBumpTask
import ir.saltech.gradle.types.ModuleVersion
import ir.saltech.gradle.util.file
import ir.saltech.gradle.util.moduleVersion
import ir.saltech.gradle.util.outputFile
import ir.saltech.gradle.util.readFirstLine
